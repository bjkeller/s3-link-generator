...
- [x] 1. Add hypothesis dependency and regenerate Pants lockfile
...
- [x] 2. Implement Pydantic models and custom exceptions
  - [x] 2.1 Create `lambda/s3_signed_url/src/python/s3_signed_url_lambda/models.py`
...
- [x] 3. Implement client registry
  - [x] 3.1 Create `lambda/s3_signed_url/src/python/s3_signed_url_lambda/client_registry.py`
  ...
  - [x] 3.2 Write property test for client config SSM round-trip
...
- [x] 4. Implement Lambda handler
  - [x] 4.1 Replace `lambda/s3_signed_url/src/python/s3_signed_url_lambda/lambda_function.py` with production handler
...
- [x] 5. Implement test fixtures and handler tests
  - [x] 5.1 Create `lambda/s3_signed_url/test/python/conftest.py` with shared fixtures
  ...
  - [x] 5.2 Replace `lambda/s3_signed_url/test/python/test_lambda_function.py` with production handler tests
...
- [x] 6. Implement property-based validation tests
  ...
  - [x] 6.2 Write property test for bucket authorization matching allowlist
  ...
  - [x] 6.3 Write property test for expiration resolution capping
    - Add to `test_validation.py`
